    ...
    return (
        <div className="main-div all-tasks">
            <div className='alerts'>
                { success ? <p className='text-light bg-danger p-2 mt-3'> deleted successfully!</p> : null }
                { success2 ? <p className='text-light bg-success p-2 mt-3'>Task Added Successfully!</p> : null }
            ...
            <div className="center-div">
                ...
                <ol>
                    {
                        allTasks.length > 0 ? allTasks.map((val, index) => {
                            return (
                                <div className="todocomp" key={ index }>
                                    <input type="checkbox" checked={ val.completed } />
                                    <p style={ { textDecoration: val.completed ? "line-through" : "none" } } > { val.name }  </p>
